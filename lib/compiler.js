...
Compiler.prototype = {
  ...
  visitAttributes: function(attrs){
    ...
    if (val.inherits) {
      ...
      this.bufferExpression("jade.attrs({ " + val.buf + " }, " + val.escaped + ", {" + val.appends + "})");
    }
  },
  ...
  attrs: function(attrs){
    ...
    attrs.forEach(function(attr){
      ...
      if (attr.appends.length) {
        var append = [];
        attr.appends.forEach(function(appendedAttr) {
          append.push("{ val: " + appendedAttr.val +
                      ", escaped: " + appendedAttr.escaped + 
                      ", appended: " + appendedAttr.appended +
                      "}");
        });

        appends.push("'" + attr.name + "':[" + append.join(",") + "]");
        // constant = append.constant && constant;
        constant = false;
      } 
